...
def cached(
    ...
    def decorator(func):
        ...
        wrapper.invalidate = lambda *args, **kwargs: cache_manager.delete(
            key_func(*args, **kwargs) if key_func else func.__name__,
            namespace
        )
        ...
        for user_id in user_ids:
            ...
            if not await self.cache.exists(cache_key, "recommendations"):
                ...
                mock_recommendations = {
                    "user_id": user_id,
                    "recommendations": [{"content_id": i, "score": 0.9 - i*0.1} for i in range(10)],
        ...
        for trending_type in trending_types:
            ...
            if not await self.cache.exists(cache_key, "trending"):
                ...
                mock_trending = {
                    ...
                    "content": [{"content_id": i, "trending_score": 100-i*5} for i in range(20)],
                    "generated_at": datetime.utcnow().isoformat()
                }
        ...
        for pattern in patterns:
            try:
                ...
                if "*" in formatted_pattern:
                    ...
                    invalidation_tasks.append(
                        self.cache.delete(formatted_pattern)
                    )
