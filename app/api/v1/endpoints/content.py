...
async def update_content(
    ...
    **Features:**
    ...
    try:
        ...
        # Authorization check
        is_author = (
            existing_content["content"]["author"]["id"] == current_user["user_id"]
        )
        ...
        if any(
            key in update_data for key in ["tags", "difficulty", "duration_minutes"]
        ):
        ...
        return _format_content_response(
            existing_content, "Content updated successfully"
        )
...
async def interact_with_content(
    ...
    **Business Rules:**
    ...
    try:
        ...
        return {
            "success": success,
            "message": f"Content {interaction.interaction_type}d successfully",
        }
...
async def get_content_stats(
    content_id: int, db: AsyncSession = Depends(get_db)
) -> ContentStatsResponse:
    """
...
def _format_content_response(
    content_detail: Dict[str, Any], message: str = None
) -> ContentResponse:
