...
class Content(Base):
    ...
    category_id: Mapped[Optional[int]] = mapped_column(
        ForeignKey("content_categories.id"), index=True
    )
    ...
    recommendation_logs: Mapped[List["RecommendationLog"]] = relationship(
        "RecommendationLog", back_populates="content", cascade="all, delete-orphan"
    )
    ...
    def tags(self) -> List[str]:
        ...
        return self.content_metadata.get("tags", []) if self.content_metadata else []
