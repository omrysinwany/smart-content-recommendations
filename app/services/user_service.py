...
class UserService(BaseService):
    ...
    async def follow_user(self, follower_id: int, followed_id: int) -> bool:
        ...
        """
        self._log_operation(
            "follow_user", follower_id=follower_id, followed_id=followed_id
        )
        ...
        try:
            ...
            if success:
                ...
                self.logger.info(
                    f"Follow already exists: {follower_id} -> {followed_id}"
                )
    ...
    async def unfollow_user(self, follower_id: int, followed_id: int) -> bool:
        ...
        """
        self._log_operation(
            "unfollow_user", follower_id=follower_id, followed_id=followed_id
        )
    ...
    async def update_user_preferences(
        ...
        try:
            ...
            updated_user = await self.user_repo.update(
                user_id, {"preferences": merged_prefs}
            )
