...
from app.core.cache import CacheManager, cached, CacheWarmer, CacheInvalidator
...
class TestCacheInvalidator:
    ...
    @pytest.mark.asyncio
    async def test_user_update_invalidation(self, cache_invalidator, mock_cache_manager):
    ...
    @pytest.mark.asyncio
    async def test_content_update_invalidation(self, cache_invalidator, mock_cache_manager):
