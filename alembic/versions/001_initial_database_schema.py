...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_content_categories_name'), 'content_categories', ['name'], unique=False)
    ...
    op.create_table('content',
        ...
        sa.Column('content_type', sa.Enum('ARTICLE', 'VIDEO', 'COURSE', 'BOOK', 'PODCAST', name='contenttype'), nullable=False),
    ...
    op.create_index(op.f('ix_content_trending_score'), 'content', ['trending_score'], unique=False)
    ...
    op.create_table('interactions',
        ...
        sa.Column('interaction_type', sa.Enum('VIEW', 'LIKE', 'SHARE', 'COMMENT', 'SAVE', 'RATE', 'CLICK', name='interactiontype'), nullable=False),
    ...
    op.create_index('ix_content_published_trending', 'content', ['is_published', 'trending_score'], unique=False)
